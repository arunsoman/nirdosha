...
pub struct ExtractedUserStory {
    ...
    /// to emit it. See `contract_check`'s module doc / `ROADMAP.md`'s
    ...
    /// real `requires(role: "...")` — 2026-08-26, `WORKFLOW.md`'s
...
pub struct ExtractedState {
    ...
    /// this yet (`WORKFLOW.md`'s proposal names the gap directly) — this
...
/// these — see `ROADMAP.md`'s contract-checking entry for why this is a
