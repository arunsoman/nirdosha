...
about: Propose a new language feature, builtin, or capability
title: ""
labels: enhancement
assignees: ""
---
...
Describe the concrete problem — what can't you express or do today?
Prefer a real use case over an abstract one.

**Proposed shape**

If you have a rough idea of the syntax/API, sketch it — doesn't need to
be final.

```nirdosha
paste a sketch here, if you have one
```
...
What are you doing today to work around not having this?
