---
name: nirdosha
description: Write, review, or fix Nirdosha (.nir) source files. Use whenever the user asks for Nirdosha code, mentions a .nir file, or asks to add/modify a struct, screen, or fn in a Nirdosha project. Covers syntax rules, types, ownership, builtins, and the compiler-verification loop.
---
