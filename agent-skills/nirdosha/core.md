<!--
This is the shared source content for every per-platform agent file in
this directory (Claude Code Skill, AGENTS.md, Cursor rules, Copilot
instructions, Windsurf, Cline, and the paste-anywhere prompt). Most of
